...
class TestAvaliacaoFraude:
    ...
    def test_expande_campos_fraude_sucesso(
        self,
        transformer,
        df_pagamentos_com_struct,
        spark_session
    ):
        """
    ...
    def test_valores_fraude_corretos(
        self,
        transformer,
        df_pagamentos_com_struct
    ):
...
class TestAddValorTotal:
    ...
    def test_calculo_valor_total_correto(
        self,
        transformer,
        df_pedidos_validos
    ):
    ...
    def test_valor_total_com_valores_grandes(
        self,
        transformer,
        df_pedidos_edge_cases
    ):
    ...
    def test_valor_total_com_null(
        self,
        transformer,
        spark_session,
        schema_pedidos,
        dados_pedidos_com_null
    ):
    ...
    def test_nao_modifica_colunas_originais(
        self,
        transformer,
        df_pedidos_validos
    ):
...
class TestFiltraPagamentos:
    ...
    def test_filtra_apenas_pagamentos_validos(
        self,
        transformer,
        df_pagamentos_com_fraude
    ):
        """
        Testa se filtra apenas pagamentos com status=False e fraude=False.
        """
        # Act
        resultado = transformer.filtra_pagamentos_aprovados_sem_fraude(
            df_pagamentos_com_fraude
        )
    ...
    def test_remove_pagamentos_com_fraude(
        self,
        transformer,
        df_pagamentos_com_fraude
    ):
    ...
    def test_remove_pagamentos_com_status_invalido(
        self,
        transformer,
        df_pagamentos_com_fraude
    ):
    ...
    def test_retorna_vazio_quando_nenhum_valido(
        self,
        transformer,
        spark_session,
        schema_pagamentos
...
class TestFiltraPedidos:
    ...
    def test_filtra_apenas_pedidos_2025(
        self,
        transformer,
        df_pedidos_validos,
        df_pedidos_2024,
    ...
    def test_mantem_todos_pedidos_2025(
        self,
        transformer,
        df_pedidos_validos
    ):
    ...
    def test_retorna_vazio_quando_nenhum_2025(
        self,
        transformer,
        df_pedidos_2024
    ):
...
class TestJoinPagamentosPedidos:
    ...
    def test_join_retorna_colunas_corretas(
        self,
        transformer,
        df_pagamentos_validos,
        df_pedidos_validos
    ):
        """Testa se o join retorna apenas as colunas esperadas."""
        # Act
        resultado = transformer.join_pagamentos_pedidos(
            df_pagamentos_validos,
            df_pedidos_validos
        )
    ...
    def test_join_inner_combina_corretamente(
        self,
        transformer,
        df_pagamentos_validos,
        df_pedidos_validos
    ...
    def test_join_sem_match_retorna_vazio(
        self,
        transformer,
        spark_session,
        schema_pagamentos,
...
class TestOrdenar:
    ...
    def test_ordenacao_uf_crescente(
        self,
        transformer,
        spark_session
    ):
    ...
    def test_ordenacao_com_um_registro(
        self,
        transformer,
        spark_session
    ):
